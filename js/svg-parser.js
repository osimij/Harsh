...
export class SVGParser {
    ...
    extractPaths(element, parentTransform = null) {
        ...
        for (const child of element.children) {
            ...
            switch (tagName) {
                case 'path':
                    paths.push(this.parsePath(child, transform));
                    break;
                case 'rect':
                    paths.push(this.parseRect(child, transform));
                    break;
                case 'circle':
                    paths.push(this.parseCircle(child, transform));
                    break;
                case 'ellipse':
                    paths.push(this.parseEllipse(child, transform));
                    break;
                case 'polygon':
                    paths.push(this.parsePolygon(child, transform));
                    break;
                case 'polyline':
                    paths.push(this.parsePolyline(child, transform));
                    break;
                case 'line':
                    paths.push(this.parseLine(child, transform));
                    break;
                case 'g':
                case 'svg':
                    ...
                    break;
                case 'text':
                    // Convert text to path if possible
                    paths.push(this.parseText(child, transform));
                    break;
            }
        }
